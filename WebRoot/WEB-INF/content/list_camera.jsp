...
<body>
	...
	<div class="ch-container">
							...
							<div class="box-header well" data-original-title="">
								...
								<div class="box-icon">
									<button class="btn btn-setting btn-round btn-default" type="button" 
										data-toggle="modal" data-target="#modal_camera_save">
									...
									<tbody id="camera_tbody">
										<c:forEach var="camera" items="${cameraList }">
											<tr id="camera_tr_${camera.id }">
												...
												<td class="center">
													<a class="btn btn-info btn-xs" href="javascript:void(0)" onclick="editCameraForm(${camera.id })"> 
														<i class="glyphicon glyphicon-edit icon-white"></i>
														编辑
													</a>
													<a class="btn btn-danger btn-xs" href="javascript:void(0)" onclick="deleteCamera(${camera.id })"> 
		...
		<div class="modal fade" id="modal_camera_update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					...
					<form class="form-horizontal" id="form_camera_update" method="post">
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input class="form-control" name="camera.angleReturn" id="angleReturn" type="text" value="">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select class="form-control" name="camera.lightSource" id="lightSource">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select class="form-control" name="camera.accessMode" id="accessMode">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select class="form-control" name="camera.temperatureDifference" id="temperatureDifference">
						...
						<div class="modal-footer">
							...
							<a href="javascript:void(0)" class="btn btn-primary" onclick="updateCamera()">保存修改</a>
						</div>
					</form>
				</div>
			</div>
		...
		<div class="modal fade" id="modal_camera_save" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">×</button>
					...
					<form class="form-horizontal" id="form_camera_save" method="post">
						...
						<div class="modal-footer">
							<a href="#" class="btn btn-default" data-dismiss="modal">关闭</a>
							<a href="javascript:void(0)" class="btn btn-primary" onclick="saveCamera()">增加镜头</a>
						</div>
					</form>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		function editCameraForm(id) {
			$('#modal_camera_update').modal('show').on('shown.bs.modal', function() {
				$("#camera_id").val(id);

				$("#form_camera_update input[type='text']").each(function(index) {
					$(this).val($("#camera_tbody #camera_tr_" + id + " td:eq("	+ index + ")").text());
				});

				$("#form_camera_update select").each(function(index){
					$(this).val($("#camera_tbody #camera_tr_" + id + " td:eq(" + (index + 9) + ")").attr("id"));
				});
		...
		function saveCamera() {
			...
			if(input_check){
				...
				$('#modal_camera_update').modal('hide').on('hidden.bs.modal', '.modal', function() {
					$(this).removeData('modal');
				});;
			}else{
				alert("输入不能为空！");
