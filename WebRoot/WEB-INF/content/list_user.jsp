...
<body>
	...
	<div class="ch-container">
		<div class="row">
			<div class="col-sm-2 col-lg-2">
				<s:include value="sidebar.jsp">
					<s:param name="active" value="'user'"/>
				</s:include>
			</div>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							...
							<div class="box-content">
								<table id="table_authority" class="display">
									<thead>
										<tr>
											<th>用户名</th>
											<th>密码</th>
		...
		<div class="modal fade" id="modal_user_update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal fade" id="modal_user_save" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">×</button>
